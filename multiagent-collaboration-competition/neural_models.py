...
class ActorCriticWrapper:
    """Wrapper for all the networks of a single agent."""
    
    def __init__(self, num_agents, state_size=24, action_size=2, seed=42):
        """Wrap both local and target for either actor and critic into one model.
        Params
        ======
